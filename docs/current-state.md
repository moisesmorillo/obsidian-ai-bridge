...
- Vitest **5**: **44 source test files / 588 tests**, plus **1 artifact file /
...
- Root Vitest projects include shared packages, Worker and plugin. Current source
  coverage is statements **95.03%**, branches **91.52%**, functions **98.40%**, lines
