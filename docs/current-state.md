...
- Vitest **5**: **64 source test files / 840 tests**, plus **1 generated-artifact
...
- Root Vitest projects include shared packages, Worker and plugin. M4 Slice 1 source
  coverage is statements **95.00%**, branches **90.54%**, functions **98.40%**, lines
  **97.02%**; thresholds and production inclusion remain enforced. Artifact tests are separate
