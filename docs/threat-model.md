...
accepted boundary. M5 Slices 2–3 now implement the credential registry, typed principal,
offline lifecycle, singleton migration checkpoint, and client-attributed content-free
live diagnostics; route permission enforcement remains Slice 4. It is a design and prioritization artifact, not a
